...
The count method is used to count the number of times a specific element appears in a tuple.

#2 index Method:

The index method returns the position of the first occurrence of a specified element in the tuple.
